...
tickers = [
    ...
    "SHY",  # Short-term Bonds - represents short-term US government bonds (1-3 years)
    "BIL",  #  # Cash - represents ultra-short-term US Treasury bills (0–3 months)
...
portfolios = {
    ...
    "Golden_Butterfly": {"SHY": 0.20, "VBR": 0.20, "VV": 0.20, "TLT": 0.20, "GLD": 0.20},
}
